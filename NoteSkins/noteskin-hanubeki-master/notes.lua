...
return function(button_list, stepstype, skin_parameters)
	...
	local columnSizeTable = {
		...
		StepsType_Horizon_Single = {
			width = {56, 56, 56, 56, 56, 56, 56, 56, 56},
		},
		StepsType_Horizon_Double = {
			width = {44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44},
		},
	};
...
Column Color Reference (+1 for white outline):
	...
	local columnColorTable = {
		...
		StepsType_Horizon_Single = {3, 5, 1, 9, 7, 19, 1, 5, 3},
		StepsType_Horizon_Double = {3, 5, 1, 9, 7, 19, 1, 5, 3, 3, 5, 1, 9, 7, 19, 1, 5, 3},
	};
